...
export const signUpRequest = async (reuqestBody: SignUpRequestDto) => {
    const result = await axios.post(SIGN_UP_URL(), reuqestBody)
        .then(response => {
...
export const deleteBoardReqeust = async (boardNumber: number | string, accessToken: string) => {
