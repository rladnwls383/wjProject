...
export default function Authentication() {
  ...
  const SignInCard = () => {
    ...
    // component: sign in card 컴포넌트 렌더링
    return (
  ...
  const SignUpCard = () => {
    ...
    const onTelNumberChangHandler = (event: ChangeEvent<HTMLInputElement>) => {
      const { value } = event.target;
      setTelNumber(value);
          ...
          <div className='auth-card-top'>
            ...
            {page === 2 && (
              <>
                ...
                <InputBox ref={telNumberRef} label='핸드폰 번호*' type='text' placeholder='핸드폰 번호를 입력해주세요.' value={telNumber} onChange={onTelNumberChangHandler} error={isTelNumberError} message={telNumberErrorMessage} onKeyDown={onTelNumberKeyDownHandler}/>
